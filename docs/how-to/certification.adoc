...
* xref:../reference/compliance-tiers.adoc[Compliance Tier Definitions] — detailed requirements
* xref:ci-integration.adoc[Adding TCK to Your CI Pipeline] — automate compliance testing
