...
This guide explains how to test TypeScript, Go, or any non-Python implementation against the Python TCK test suite using the HTTP bridge protocol.
...
----
 Python TCK Tests
       |
       v
 HTTPBridgeAdapter ──HTTP POST──> Conformance Server (TS/Go/etc.)
                                        |
                                        v
                                  Your Native Client
                                        |
