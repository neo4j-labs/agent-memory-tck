...
. Implement POST handlers for each `BaseAdapter` method. See xref:../reference/bridge-protocol.adoc[Bridge Protocol Specification] for the full endpoint list.
...
* xref:../reference/bridge-protocol.adoc[HTTP Bridge Protocol Specification] — full endpoint and data type reference
* xref:ci-integration.adoc[Adding TCK to Your CI Pipeline] — automate bridge testing in CI
