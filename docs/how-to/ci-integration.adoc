...
* xref:cross-language-testing.adoc[Cross-Language Conformance Testing] — bridge protocol details
* xref:certification.adoc[Obtaining TCK Certification] — submitting results to the registry
