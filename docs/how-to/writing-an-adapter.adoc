...
* link:../reference/base-adapter.html[BaseAdapter Interface Reference] — complete method signatures
* link:../reference/compliance-tiers.html[Compliance Tier Definitions] — pass rate requirements
* link:certification.html[Obtaining TCK Certification] — submitting your results
