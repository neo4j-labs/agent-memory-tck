...
TIP: If you only want to use the hosted service from your application (not run the conformance suite against your own backend), start with the link:hosted-quickstart.html[Hosted-Service Quickstart] instead.

== Prerequisites

* Python 3.10 or later
* https://docs.astral.sh/uv/[uv] package manager (recommended) or pip
* A running Neo4j instance (local or Aura) _or_ a `nams_*` API key for the hosted service at `https://memory.neo4jlabs.com/v1`
