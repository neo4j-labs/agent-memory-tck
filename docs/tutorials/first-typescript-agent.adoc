...
* link:../reference/base-adapter.html[BaseAdapter Interface Reference] — all available memory operations
* link:../explanation/memory-model.html[The Agent Memory Model] — understanding short-term, long-term, and reasoning memory
