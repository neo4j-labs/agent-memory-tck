...
// Auto-selects RestTransport when endpoint contains /v1.
...
* link:../how-to/framework-integrations.html[Framework Integrations] — LangChain JS, Mastra, MCP, and more
* link:../how-to/authenticate.html[Authenticate] — API key rotation, OAuth refresh, scope management
...
* link:../explanation/memory-model.html[The Agent Memory Model] — short-term, long-term, reasoning, plus observations and reflections
